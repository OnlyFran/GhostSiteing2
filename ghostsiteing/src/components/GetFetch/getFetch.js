...
let productos = [
    {id: 1, categoria:'juego', nombre: "Juego de la Copa", descripcion:"Basado en la Ouija, abecedario en formato de tarjetas y una copa" , stock: 15, imagen:juegoCopa, precio: 1200},
    {id: 2, categoria: 'juego', nombre: "Tablero Ouija", descripcion:"El famoso tablero Ouija, incluye un tablero y una plancheta" , stock: 15, imagen:ouija, precio: 5000},
